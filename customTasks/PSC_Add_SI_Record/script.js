...
*/
function addSI(PSCIP,PSCPort,PSCProtocol,PSCUser,PSCPassword,SITableName,SIData,action){
	if (PSCProtocol == "http"){
...
addSI(PSCIP,PSCPort,PSCProtocol,PSCUser,PSCPassword,SITableName,SIData,action);
